...
const About = () => {
  ...
  const complianceItems = [
    { icon: <ShieldCheck size={42} className="text-customGreen" />, key: "basel" },
    { icon: <FaHandshake size={40} className="text-customGreen" />, key: "partnerships" },
    { icon: <Globe2 size={40} className="text-customGreen" />, key: "standards" },
    { icon: <FaLeaf size={40} className="text-customGreen" />, key: "iso" },
    { icon: <FaRecycle size={40} className="text-customGreen" />, key: "circular" }
  ];
